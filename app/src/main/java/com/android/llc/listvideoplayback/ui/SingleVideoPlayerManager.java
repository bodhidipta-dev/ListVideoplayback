...
import com.android.llc.listvideoplayback.ui.player_messages.ClearPlayerInstance;
import com.android.llc.listvideoplayback.ui.player_messages.CreateNewPlayerInstance;
import com.android.llc.listvideoplayback.ui.player_messages.Prepare;
import com.android.llc.listvideoplayback.ui.player_messages.Release;
import com.android.llc.listvideoplayback.ui.player_messages.Reset;
import com.android.llc.listvideoplayback.ui.player_messages.SetAssetsDataSourceMessage;
import com.android.llc.listvideoplayback.ui.player_messages.SetUrlDataSourceMessage;
import com.android.llc.listvideoplayback.ui.player_messages.Start;
import com.android.llc.listvideoplayback.ui.player_messages.Stop;
...
public class SingleVideoPlayerManager implements VideoPlayerManager<MetaData>, VideoPlayerManagerCallback, MediaPlayerWrapper.MainThreadMediaPlayerListener {
    ...
    public void playNewVideo(MetaData currentItemMetaData, VideoPlayerView videoPlayerView, String videoUrl) {
        Logger.showLog(TAG,">> playNewVideo, videoPlayer " + videoPlayerView + ", mCurrentPlayer " + mCurrentPlayer + ", videoPlayerView " + videoPlayerView);
        ...
        boolean isAlreadyPlayingTheFile =
         ...
         Logger.showLog(TAG, "playNewVideo, isAlreadyPlayingTheFile " + isAlreadyPlayingTheFile);
         Logger.showLog(TAG, "playNewVideo, currentPlayerIsActive " + currentPlayerIsActive);
        /** 2. */
        if(currentPlayerIsActive){
            if(isInPlaybackState() && isAlreadyPlayingTheFile){
                Logger.showLog(TAG,"playNewVideo, videoPlayer " + videoPlayerView + " is already in state " + mCurrentPlayerState);
                /** 3. */
            } else {
                /** 4. */
        ...
        Logger.showLog(TAG, "<< playNewVideo, videoPlayer " + videoPlayerView + ", videoUrl " + videoUrl);
    }
    ...
    public void playNewVideo(MetaData currentItemMetaData, VideoPlayerView videoPlayerView, AssetFileDescriptor assetFileDescriptor) {
        Logger.showLog(TAG,">> playNewVideo, videoPlayer " + videoPlayerView + ", mCurrentPlayer " + mCurrentPlayer + ", assetFileDescriptor " + assetFileDescriptor);
        Logger.showLog(TAG,"playNewVideo, currentItemMetaData " + currentItemMetaData);
        ...
        Logger.showLog(TAG, "<< playNewVideo, videoPlayer " + videoPlayerView + ", assetFileDescriptor " + assetFileDescriptor);
    }

    private boolean isInPlaybackState() {
        boolean isPlaying = mCurrentPlayerState == PlayerMessageState.STARTED || mCurrentPlayerState == PlayerMessageState.STARTING;
        Logger.showLog(TAG, "isInPlaybackState, " + isPlaying);
        return isPlaying;
    }
    ...
    private void startNewPlayback(MetaData currentItemMetaData, VideoPlayerView videoPlayerView, AssetFileDescriptor assetFileDescriptor) {
        ...
        videoPlayerView.addMediaPlayerListener(this);
         Logger.showLog(TAG, "startNewPlayback, mCurrentPlayerState " + mCurrentPlayerState);
    ...
    public void stopAnyPlayback() {
        Logger.showLog(TAG,">> stopAnyPlayback, mCurrentPlayerState " + mCurrentPlayerState);
    ...
    public void resetMediaPlayer() {
        Logger.showLog(TAG,">> resetMediaPlayer, mCurrentPlayerState " + mCurrentPlayerState);
    ...
    private void startPlayback(VideoPlayerView videoPlayerView, String videoUrl) {
        Logger.showLog(TAG, "startPlayback");
    ...
    private void setNewViewForPlayback(MetaData currentItemMetaData, VideoPlayerView videoPlayerView) {
        Logger.showLog(TAG, "setNewViewForPlayback, currentItemMetaData " + currentItemMetaData + ", videoPlayer " + videoPlayerView);
    ...
    private void stopResetReleaseClearCurrentPlayer() {
        Logger.showLog(TAG, "stopResetReleaseClearCurrentPlayer, mCurrentPlayerState " + mCurrentPlayerState +", mCurrentPlayer " + mCurrentPlayer);
    ...
    private void resetReleaseClearCurrentPlayer() {
        Logger.showLog(TAG, "resetReleaseClearCurrentPlayer, mCurrentPlayerState " + mCurrentPlayerState +", mCurrentPlayer " + mCurrentPlayer);
    ...
    public void setCurrentItem(MetaData currentItemMetaData, VideoPlayerView videoPlayerView) {
        Logger.showLog(TAG, ">> onPlayerItemChanged");
    ...
    public void setVideoPlayerState(VideoPlayerView videoPlayerView, PlayerMessageState playerMessageState) {
        Logger.showLog(TAG, ">> setVideoPlayerState, playerMessageState " + playerMessageState + ", videoPlayer " + videoPlayerView);
    ...
    public PlayerMessageState getCurrentPlayerState() {
        Logger.showLog(TAG, "getCurrentPlayerState, mCurrentPlayerState " + mCurrentPlayerState);
    ...
    public void onErrorMainThread(int what, int extra) {
        Logger.showLog(TAG, "onErrorMainThread, what " + what + ", extra " + extra);
